...
const Form = ({isSignInPage = true}) => {
    ...
    const handleSubmit = async(e) => {
        ...
        e.preventDefault()
        const res = await fetch(`https://chat-app-4-9jcn.onrender.com/api/${isSignInPage ? 'login' : 'register'}`, {
            method: 'POST',
            headers: {
  ...
  return (
    ...
    <div className="bg-light h-screen flex items-center justify-center">
        <div className=" bg-white w-[600px] h-[800px] shadow-lg rounded-lg flex flex-col justify-center items-center">
            ...
            <div className=" text-xl font-light mb-14">{isSignInPage ? 'Sign in to get explored' : 'Please sign in after sign up to get started'}</div>
